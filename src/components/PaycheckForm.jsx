...
export default function PaycheckForm({ onCalculate, isManual, setIsManual }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
      ...
      >
        {isManual ? "Switch to Calculator" : "Switch to Manual Entry"}
      </button>
        {isManual && (
      ...
      >
        {isManual ? "Log Paycheck" : "Calculate Paycheck"}
      </button>
    </form>
  );
}
